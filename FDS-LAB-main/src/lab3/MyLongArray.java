...
public class MyLongArray {
    ...
    public void seta(int i, long val) {
        a[i] = val;
    }

    public void geta(long[] b) {
        System.arraycopy(a, 0, b, 0, a.length);
    }


    public void setci(int k) {
        currentIndex = k;
    }
     ...
     */
    public void insert(long value) throws IllegalStateException {

        if(currentIndex==a.length) throw new IllegalStateException("Array is full");
    ...
    public void insert(int index, long value) {
        ...
        if (index >= currentIndex) {
            ...
            currentIndex++;
            System.out.
                    println("Index greater than currentIndex value inserted at end");
            return;
        }
