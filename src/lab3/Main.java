...
public class Main {
    public static void main(String[] args) {
        ...
        while (loop) {                //Menu for array
            ...
            System.out.
                    println
                            ("Select the operation you want to perform by typing the respective number: ");
            ...
            System.out.
                    println("6) Delete duplicate elements of a certain value");
            System.out.println("7) Insert element at a particular index");
            System.out.println("8) Delete element at a particular index");
            System.out.
                    println
                            ("9) Initialize all elements of the array with random values ");
            System.out.println("10) Sort array using Bubble Sort Algorithm");
            System.out.
                    println("11) Sort array using Selection Sort Algorithm");
            System.out.
                    println("12) Sort array using Insertion Sort Algorithm");
            ...
            switch (op) {
                ...
                case 7:
                    System.out.
                            print
                                    ("Please input index and value of element to be inserted: ");
                    index = sc.nextInt();
                    value = sc.nextLong();
                ...
                case 8:
                    System.out.
                            print("Please input index of element to be deleted: ");
                    index = sc.nextInt();
                    ...
                    break;
                case 9:
                    System.out.print("Array initialized to: ");
                    s.initArray(arr);
                    break;
                case 10:
                    s.bubbleSort(arr);
